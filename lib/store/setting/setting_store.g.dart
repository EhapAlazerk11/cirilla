...
mixin _$SettingStore on _SettingStore, Store {
  ...
  Computed<ObservableList<String?>>? _$tabsComputed;

  @override
  ObservableList<String?> get tabs =>
      (_$tabsComputed ??= Computed<ObservableList<String?>>(() => super.tabs, name: '_SettingStore.tabs')).value;
  ...
  final _$_tabsAtom = Atom(name: '_SettingStore._tabs');

  @override
  ObservableList<String?> get _tabs {
    _$_tabsAtom.reportRead();
    return super._tabs;
  }

  @override
  set _tabs(ObservableList<String?> value) {
  ...
  @override
  dynamic removeTab() {
    final _$actionInfo = _$_SettingStoreActionController.startAction(name: '_SettingStore.removeTab');
    try {
