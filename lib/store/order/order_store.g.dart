...
mixin _$OrderStore on _OrderStore, Store {
  ...
  int get perPage => (_$perPageComputed ??=
          Computed<int>(() => super.perPage, name: '_OrderStore.perPage'))
      .value;
  ...
  bool get canLoadMore =>
      (_$canLoadMoreComputed ??= Computed<bool>(() => super.canLoadMore,
              name: '_OrderStore.canLoadMore'))
          .value;
  Computed<bool>? _$loadingComputed;

  @override
  bool get loading => (_$loadingComputed ??=
          Computed<bool>(() => super.loading, name: '_OrderStore.loading'))
      .value;
  Computed<bool>? _$loadingNodeComputed;

  @override
  bool get loadingNode =>
      (_$loadingNodeComputed ??= Computed<bool>(() => super.loadingNode,
              name: '_OrderStore.loadingNode'))
          .value;
  ...
  final _$fetchOrderNodeFutureAtom =
      Atom(name: '_OrderStore.fetchOrderNodeFuture');
  ...
  Future<void> refresh() {
    final _$actionInfo =
        _$_OrderStoreActionController.startAction(name: '_OrderStore.refresh');
    try {
