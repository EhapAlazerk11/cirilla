...
mixin _$PostStore on _PostStore, Store {
  ...
  @override
  String get postType =>
      (_$postTypeComputed ??= Computed<String>(() => super.postType, name: '_PostStore.postType')).value;
  ...
  final _$_postTypeAtom = Atom(name: '_PostStore._postType');
  ...
  final _$_authorsAtom = Atom(name: '_PostStore._authors');
