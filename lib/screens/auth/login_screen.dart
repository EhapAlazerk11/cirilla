...
class _LoginScreenState extends State<LoginScreen> with AppBarMixin, LoadingMixin, SnackMixin, Utility {
  ...
  Widget build(BuildContext context) {
    ...
    return Observer(builder: (_) {
      ...
      return Scaffold(
        ...
        body: Stack(
          children: [
            buildLayout(layout, widgetConfig, background, translate),
  ...
  Widget buildLayout(String layout, WidgetConfig widgetConfig, Color background, TranslateType translate) {
...
class _TextRegister extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        Text(translate('login_description_register')!, style: textTheme.caption),
        SizedBox(width: 8),
        TextButton(
