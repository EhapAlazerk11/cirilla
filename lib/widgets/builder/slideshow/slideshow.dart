...
import 'package:cirilla/widgets/cirilla_pagination_swiper.dart';
...
class SlideshowWidget extends StatelessWidget with Utility, NavigationMixin {
  ...
  Widget _buildLayer(BuildContext context, {Map<String, dynamic>? layerItem}) {
    ...
    double? width = ConvertData.stringToDoubleCanBeNull(position['width'], null);
    double? height = ConvertData.stringToDoubleCanBeNull(position['height'], null);
    ...
    double? right = ConvertData.stringToDoubleCanBeNull(position['right'], null);
    double? bottom = ConvertData.stringToDoubleCanBeNull(position['bottom'], null);
