...
class _LayoutSlideshowState extends State<LayoutSlideshow> {
  ...
  Widget build(BuildContext context) {
    double widthView = widget.widthView! - widget.padding.end - widget.padding.start;
        ...
        child: Swiper(
          ...
          itemBuilder: (BuildContext context, int index) {
            return Container(
              ...
              child: Column(
                children: [
                  widget.buildItem!(context, category: widget.categories![index], width: width, height: null),
                ],
              ),
            );
          },
