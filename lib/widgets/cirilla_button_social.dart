...
class CirillaButtonSocial extends StatelessWidget {
  ...
  factory CirillaButtonSocial.instagram({
    double? size,
    double? sizeIcon,
    VoidCallback? onPressed,
    IconData? icon,
  ...
  factory CirillaButtonSocial.snapchat({
    double? size,
    double? sizeIcon,
    VoidCallback? onPressed,
    IconData? icon,
...
class _CirillaButtonSocialInstagram extends CirillaButtonSocial {
  ...
  Widget build(BuildContext context) {
    return buildContainer(
      ...
      boxFit: boxFit,
      type: type,
      icon: buildIcon(icon: icon, color: Color(0xFF833AB4), size: sizeIcon, boxFit: boxFit),
    );
  }
}
...
class _CirillaButtonSocialSnapchat extends CirillaButtonSocial {
  ...
  Widget build(BuildContext context) {
    return buildContainer(
      ...
      boxFit: boxFit,
      type: type,
      icon: buildIcon(icon: icon, color: Color(0xFFFFFC00), size: sizeIcon, boxFit: boxFit),
    );
  }
}
